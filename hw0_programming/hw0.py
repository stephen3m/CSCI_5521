...
w, initial_error_rate, predict_error_rate = MyPerceptron(X,y,w0)
print(w)
...
print('Initial Error Rate for Perceptron: %.2f' % initial_error_rate)       # example of a formatted print
print('Final Error Rate for Perceptron: %.2f' % predict_error_rate)       # example of a formatted print
